...
class absenteeism_model():
        ...
        def __init__(self, model_file, scaler_file):
            ...
            with open('/Users/promojz/Documents/Business_Problem_ML_Project/Model/model','rb') as model_file, open('/Users/promojz/Documents/Business_Problem_ML_Project/Model/scaler', 'rb') as scaler_file:
        ...
        def predicted_outputs(self):
            if (self.data is not None):
                ...
                bool_cols = self.preprocessed_data.select_dtypes(include='bool').columns
                self.preprocessed_data[bool_cols] = self.preprocessed_data[bool_cols].astype(int)
